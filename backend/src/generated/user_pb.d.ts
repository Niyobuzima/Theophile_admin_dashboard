...
export namespace user {
    ...
    class UserList implements IUserList {
         ...
         */
        public static create(properties?: user.IUserList): user.UserList;
         ...
         * @returns Writer
         */
        public static encode(message: user.IUserList, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: user.IUserList, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): user.UserList;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): user.UserList;
         ...
         * @returns UserList
         */
        public static fromObject(object: { [k: string]: any }): user.UserList;
         ...
         * @returns Plain object
         */
        public static toObject(message: user.UserList, options?: $protobuf.IConversionOptions): { [k: string]: any };
